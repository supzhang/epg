...
def get_epgs_cctv(channel, channel_id, dt, func_arg):
    ...
    url = 'http://api.cntv.cn/epg/getEpgInfoByChannelNew?c=%s&serviceId=tvcctv&d=%s&t=jsonp&cb=set' % (
...
def get_channels_cctv():
    ...
    for li in lis:
        ...
        url_info = 'http://api.cntv.cn/epg/getEpgInfoByChannelNew?c=%s&serviceId=tvcctv&d=%s&t=jsonp&cb=set' % (
        id, need_date)
